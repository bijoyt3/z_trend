...
s3_client = boto3.client(service_name='s3',
                         region_name=secrets['AWS_CREDS']['aws_region'],
                         aws_access_key_id=secrets['AWS_CREDS']['aws_access_key_id'],
                         aws_secret_access_key=secrets['AWS_CREDS']['aws_secret_access_key'])
